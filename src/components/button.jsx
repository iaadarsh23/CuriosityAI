...
const Button = ({ href, onClick, children }) => {
	return (
		<div>
			<button className="relative inline-flex  w-full h-12 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
