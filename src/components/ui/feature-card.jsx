...
export function CardDemo() {
	return (
		<Card>
			...
			<CardDescription>
				Seamlessly integrate with leading AI platforms to enhance your
...
export const CardTitle = ({ children, className }) => {
	return (
		<h3 className={cn("text-xl font-semibold text-white py-2", className)}>
			{children}
		</h3>
	);
};
...
export const CardDescription = ({ children, className }) => {
	return (
		<p className={cn("text-sm font-normal text-gray-300 max-w-sm", className)}>
			{children}
		</p>
	);
};
